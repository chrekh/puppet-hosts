...
class hosts (
  ...
  Array[String] $lo_ipv4       = hosts::collect_lo('ip'),
  Array[String] $lo_ipv6       = hosts::collect_lo('ip6'),
  ...
  Array[String] $primary_ipv4  = hosts::collect_other('ip'),
  Array[String] $primary_ipv6  = hosts::collect_other('ip6'),
